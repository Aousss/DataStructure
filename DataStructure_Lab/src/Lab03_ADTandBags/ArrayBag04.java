...
public class ArrayBag04<T> implements BagInterface04<T> {
    ...
    @Override
    public BagInterface04<T> union(BagInterface04<T> anotherBag) {
        ArrayBag04<T> newBag = new ArrayBag04();
    ...
    @Override
    public BagInterface04<T> intersection(BagInterface04<T> anotherBag) {
        BagInterface04<T> newBag = new ArrayBag04<>();
        
        BagInterface04<T> bag1;
        BagInterface04<T> bag2;
    ...
    @Override
    public BagInterface04<T> difference(BagInterface04<T> anotherBag) {
    ...
    public static void main(String[] args) {
        ArrayBag04<String> bag1 = new ArrayBag04();
        ArrayBag04<String> bag2 = new ArrayBag04();
        
        // test public BagInterface04<T> union(BagInterface04<T> anotherBag)
        bag1.add("a");
        bag1.add("b");
        bag1.add("c");
        bag2.add("b");
        ...
        bag2.add("d");
        bag2.add("e");
        BagInterface04<String> everything = bag1.union(bag2);
        ...
        // test BagInterface04<T> intersection(BagInterface04<T> anotherBag)
        bag1.add("b");
        BagInterface04<String> commonItems = bag1.intersection(bag2);
        ...
        // test BagInterface04<T> difference(BagInterface04<T> anotherBag)
        bag1.remove("b");
        BagInterface04 leftOver1 = bag1.difference(bag2);
        BagInterface04 leftOver2 = bag2.difference(bag1);
