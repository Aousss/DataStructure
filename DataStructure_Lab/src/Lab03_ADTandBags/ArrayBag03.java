...
public class ArrayBag03<T> implements BagInterface03<T> {
    ...
    @Override
    public BagInterface03<T> union(BagInterface03<T> anotherBag) {
        ArrayBag03<T> newBag = new ArrayBag03();
    ...
    @Override
    public BagInterface03<T> intersection(BagInterface03<T> anotherBag) {
        BagInterface03<T> newBag = new ArrayBag03<>();
        
        BagInterface03<T> bag1;
        BagInterface03<T> bag2;
    ...
    public static void main(String[] args) {
        ArrayBag03<String> bag1 = new ArrayBag03();
        ArrayBag03<String> bag2 = new ArrayBag03();
        
        // test public BagInterface03<T> union(BagInterface03<T> anotherBag)
        bag1.add("a");
        bag1.add("b");
        bag1.add("c");
        bag2.add("b");
        ...
        bag2.add("d");
        bag2.add("e");
        BagInterface03<String> everything = bag1.union(bag2);
        ...
        // test BagInterface03<T> intersection(BagInterface03<T> anotherBag)
        bag1.add("b");
        BagInterface03<String> commonItems = bag1.intersection(bag2);
