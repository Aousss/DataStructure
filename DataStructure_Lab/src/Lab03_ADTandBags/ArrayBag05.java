...
public class ArrayBag05<T> implements BagInterface05<T> {
    ...
    @Override
    public BagInterface05<T> union(BagInterface05<T> anotherBag) {
        ArrayBag05<T> newBag = new ArrayBag05();
    ...
    @Override
    public BagInterface05<T> intersection(BagInterface05<T> anotherBag) {
        BagInterface05<T> newBag = new ArrayBag05<>();

        BagInterface05<T> bag1;
        BagInterface05<T> bag2;
    ...
    @Override
    public BagInterface05<T> difference(BagInterface05<T> anotherBag) {
    ...
    public static void main(String[] args) {
        ...
        // test public BagInterface05<T> union(BagInterface05<T> anotherBag)
        bag1.add("a");
        bag1.add("b");
        bag1.add("c");
        bag2.add("b");
        ...
        bag2.add("d");
        bag2.add("e");
        BagInterface05<String> everything = bag1.union(bag2);
        ...
        // test BagInterface05<T> intersection(BagInterface05<T> anotherBag)
        bag1.add("b");
        BagInterface05<String> commonItems = bag1.intersection(bag2);
        ...
        // test BagInterface05<T> difference(BagInterface05<T> anotherBag)
        bag1.remove("b");
        BagInterface05 leftOver1 = bag1.difference(bag2);
        BagInterface05 leftOver2 = bag2.difference(bag1);
